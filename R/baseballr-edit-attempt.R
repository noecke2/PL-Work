# PURPOSE: Try to alter baseballr to examine date ranges rather than seasons
...
fg_pitcher_leaders_date_range(x = 2022, y = 2022, startdate = "2022-05-28", enddate = Sys.Date())
